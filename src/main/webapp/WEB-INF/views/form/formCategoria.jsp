 ...
 <body class="w3-container">
				    ...
				    <li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="../listagem/credito">Fatura Pendente
									Crédito</a></li>
							<li><a href="../form/formsituacao">Criar Situaçao </a></li>
	...
	<header>
		<div class="w3-container   w3-dark-grey">
			<h2 class="w3-center">CRIAR CATEGORIA</h2>
		</div>
		<div class="w3-row">
			<form:form class="w3-container w3-card-4" action="${spring:mvcUrl('FC#criarCategoria').build()}" commandName="categoria">
					${msg}
				<p class="w3-col s2"></p>

				<p class="w3-col s12">
					<label for="id_cat">Categoria </label> <input type="text"
						name="nome" id="id_cat" class="w3-input w3-light-grey " required>
				</p>
				<p class="w3-col s12">
					<button class="w3-button w3-block  w3-dark-grey" style="width: 30%">SAVAR</button>
				</p>
			</form:form>
		</div>
	</header>
